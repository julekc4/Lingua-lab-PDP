...
encoder_fp = "/en-de_trained_model/EN-DE-Encoder"
decoder_fp = "/en-de_trained_model/EN-DE-Decoder"
...
translate(encoder, decoder, input_lang, output_lang, "This is an example sentence!")
